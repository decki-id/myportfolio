...
class InstadeckInstagramApiController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        $getMedia = $client->request('GET', "https://graph.facebook.com/v9.0/{$instaId}/media?fields=id,media_type,media_url,username,like_count,comments_count,caption,timestamp,permalink&access_token={$accessToken}");
