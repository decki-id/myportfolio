...
class InstadeckInstagramApiController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        $getMedia = $client->request('GET', "https://graph.facebook.com/v8.0/{$instaId}/media?access_token={$accessToken}&fields=id,media_type,media_url,children{id,media_type,media_url},username,like_count,comments_count,caption,timestamp,permalink&limit=1000000");
