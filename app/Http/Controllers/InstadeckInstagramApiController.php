...
class InstadeckInstagramApiController extends Controller
{
    public function index()
    {
        ...
        return redirect()->to("http://www.facebook.com/v8.0/dialog/oauth?client_id={$appId}&redirect_uri={$redirectUri}&scope=instagram_basic,instagram_manage_insights,ads_management,business_management,pages_show_list,pages_read_engagement");
    }
