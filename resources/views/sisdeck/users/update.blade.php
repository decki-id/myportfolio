            ...
            <div class="modal-body">
                <div class="row align-items-center">
                    ...
                    <div class="form-group col-sm-9">
                        {!! Form::text('username', null, ['class' => 'form-control', 'maxlength' => 191, 'id' => 'user-username_update']) !!}
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="form-group col-sm-3">
                    ...
                    <div class="form-group col-sm-9">
                        {!! Form::text('fullname', null, ['class' => 'form-control', 'maxlength' => 191, 'id' => 'user-fullname_update']) !!}
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="form-group col-sm-3">
                    ...
                    <div class="form-group col-sm-9">
                        {!! Form::text('role_name', null, ['class' => 'form-control', 'maxlength' => 191, 'id' => 'user-role-name_update']) !!}
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="form-group col-sm-3">
                    ...
                    <div class="form-group col-sm-9">
                        {!! Form::email('email', null, ['class' => 'form-control', 'maxlength' => 191, 'id' => 'user-email_update']) !!}
                    </div>
                </div>
            </div>
