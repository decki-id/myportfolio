...
<body class="hold-transition register-page">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group has-feedback{{ $errors->has('username') ? ' has-error' : '' }}">
                            <div class="input-group">
                                <input type="text" class="form-control dhs_input-bar" id="username" name="username" value="{{ old('username') }}" placeholder="First Name">
    ...
    <script type="text/javascript">window.onload = function () { document.querySelector("#username").focus(); }</script>
</body>
</html>