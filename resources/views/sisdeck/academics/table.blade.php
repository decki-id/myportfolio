<div class="table-responsive">
    <table class="table" id="dhs_academics-table">
        <thead>
            <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{{ route('sisdeck.academics.show', [$sisdeckAcademic->id]) }}" class='btn btn-default btn-xs'><i class="fas fa-fw fa-eye-open"></i></a>
