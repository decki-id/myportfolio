...
@section('content')
    <div class="row align-items-center px-3 pt-3">
        ...
        <div class="col-sm-6 dhs_col-button">
            <a href="{{ route('sisdeck.academics.create') }}" class="btn btn-primary-lte dhs_button" id="create-academic_button">
    ...
    <div class="content">
        ...
        <div class="clearfix"></div>
        <div class="box box-primary"><div class="box-body">@include('/sisdeck/academics/table')</div></div>
