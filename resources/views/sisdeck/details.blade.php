    ...
    <div class="students">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="/sisdeck/{{$student->id}}/edit" class="btn btn-success">Update</a>
                <form method="post" action="/sisdeck/{{$student->id}}" class="d-inline">
                    @method('delete')
                    @csrf
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure?');">Delete</button>
                </form>
                <a href="/sisdeck" class="btn btn-secondary">Back</a>
            </div>
        </div>
    </div>
@endsection