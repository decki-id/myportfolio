...
@section('section')
    <div class="students">
                ...
                <form method="post" action="/sisdeck/{{$student->id}}">
                    @method('patch')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select type="text" class="form-control @error('majors') is-invalid @enderror" id="majors" name="majors">
                            ...
                            <option {{$student->majors == 'Teknik Industri' ? 'selected' : ''}}>Teknik Industri</option>
                    ...
                    <a href="/sisdeck/{{$student->id}}" class="btn btn-secondary float-right ml-1">Cancel</a>
